...
(function(e, t) {
    ...
    function o(e) {
        return 'PHP' === e.nodeName ? e : e.parentNode || e.host
    }
    function n(e) {
        if (!e)
    ...
    function r(e) {
        var o = e && e.offsetParent,
            i = o && o.nodeName;
        return i && 'BODY' !== i && 'PHP' !== i ? -1 !== ['TD', 'TABLE'].indexOf(o.nodeName) && 'static' === t(o, 'position') ? r(o) : o : e ? e.ownerDocument.documentElement : document.documentElement
    }
    function p(e) {
        var t = e.nodeName;
        return 'BODY' !== t && ('PHP' === t || r(e.firstElementChild) === e)
    }
    function s(e) {
    ...
    function w(e) {
        var i = e.nodeName;
        return 'BODY' === i || 'PHP' === i ? !1 : 'fixed' === t(e, 'position') || w(o(e))
    }
    function y(e, t, i, r) {
        var p = {
                top: 0,
